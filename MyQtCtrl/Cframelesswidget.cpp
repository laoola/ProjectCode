...
CFramelessWidget::CFramelessWidget(QObject *parent) : QObject(parent)
{
    padding = 8;
    moveEnable = true;
    resizeEnable = true;
...
bool CFramelessWidget::eventFilter(QObject *watched, QEvent *event)
{
...
void CFramelessWidget::setPadding(int padding)
{
    this->padding = padding;
}

void CFramelessWidget::setMoveEnable(bool moveEnable)
{
    this->moveEnable = moveEnable;
}

void CFramelessWidget::setResizeEnable(bool resizeEnable)
{
    this->resizeEnable = resizeEnable;
}

void CFramelessWidget::setWidget(QWidget *widget)
{
    if (this->widget == 0)
    {
        this->widget = widget;
